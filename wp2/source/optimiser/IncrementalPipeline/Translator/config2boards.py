...
from IncrementalPipeline.Objects.board import Board  # Replace with the actual module where your Board class is defined


def convert_inputboards_to_boards(input_data: Dict[str, Any]) -> List[List[Board]]:
    """
    Convert JSON-like input data containing InputBoards into a list of lists of Board objects.
    ...
    for board_entry in input_data:
        ...
        board = Board(length=raw["Length"], bad_parts=bad_parts, curved_parts=curved_parts)
