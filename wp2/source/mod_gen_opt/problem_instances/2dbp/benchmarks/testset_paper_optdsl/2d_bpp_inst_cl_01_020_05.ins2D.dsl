NBOXES : int = 20
NITEMS : int = 20
MAX_BOX_WIDTH : int = 10
MAX_BOX_HEIGHT : int = 10

BOX_WIDTH_CAPACITIES : DSList(NBOXES, DSInt()) = [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10]
BOX_HEIGHT_CAPACITIES : DSList(NBOXES, DSInt()) = [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10]

ITEM_WIDTHS : DSList(NITEMS, DSInt()) = [10, 2, 2, 10, 7, 9, 5, 7, 1, 5, 3, 9, 2, 4, 2, 4, 2, 1, 1, 4]
ITEM_HEIGHTS : DSList(NITEMS, DSInt()) = [4, 10, 4, 10, 2, 10, 6, 5, 7, 3, 9, 4, 10, 3, 2, 9, 8, 1, 7, 4]
