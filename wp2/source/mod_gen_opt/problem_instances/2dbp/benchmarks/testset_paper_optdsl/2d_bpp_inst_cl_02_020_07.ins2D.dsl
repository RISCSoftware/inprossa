NBOXES : int = 20
NITEMS : int = 20
MAX_BOX_WIDTH : int = 30
MAX_BOX_HEIGHT : int = 30

BOX_WIDTH_CAPACITIES : DSList(NBOXES, DSInt()) = [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30]
BOX_HEIGHT_CAPACITIES : DSList(NBOXES, DSInt()) = [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30]

ITEM_WIDTHS : DSList(NITEMS, DSInt()) = [10, 10, 3, 4, 2, 10, 3, 10, 3, 7, 3, 1, 8, 2, 5, 4, 6, 5, 5, 6]
ITEM_HEIGHTS : DSList(NITEMS, DSInt()) = [5, 1, 7, 3, 9, 2, 1, 8, 8, 1, 7, 4, 10, 7, 1, 1, 8, 9, 2, 9]
