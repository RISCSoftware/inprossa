BOX_WIDTH_CAPACITIES : DSList(5, DSInt()) = [14, 12, 15, 13, 11]
BOX_HEIGHT_CAPACITIES : DSList(5, DSInt()) = [10, 9, 11, 10, 8]

ITEM_WIDTHS : DSList(8, DSInt()) = [4, 3, 5, 2, 6, 3, 4, 2]
ITEM_HEIGHTS : DSList(8, DSInt()) = [3, 5, 2, 4, 3, 2, 4, 1]

NBOXES : int = 5
NITEMS : int = 8
MAX_BOX_WIDTH : int = 15
MAX_BOX_HEIGHT : int = 11
