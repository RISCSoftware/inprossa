...
class Predicate(CodeBlock):
    ...
    def __init__(self, func_node: ast.FunctionDef, predicates=None, types=None, constant_table=None, name_override: str | None = None, dsl_index_base: int = 0):
        super().__init__(constant_table=constant_table, predicates=predicates, types=types, dsl_index_base=dsl_index_base)
