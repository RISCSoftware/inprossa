...
from run_test_files_dfs import paper_20_CLASS_5_tot_flex_shapes, updateTreeCollectionCorrectnessResultsWithObjective
...
if __name__ == '__main__':
    ...
    updateTreeCollectionCorrectnessResultsWithObjective(tree_collection_path, handcrafted_objective_values)
