...
d2_bin_packing_formalized_problem_description_inst2 = InputReader.read_problem_description_from_file(
        ...
        "problem_descriptions/2d_bin_packing_inst_1.json") # 1
...
d2_bin_packing_formalized_problem_description_inst2 = InputReader.read_problem_description_from_file(
        ...
        "problem_descriptions/2d_bin_packing_inst_1.json") # 4
...
def build_up_formulation_iteratively():
    N_FAILED_GENERATIONS = 0
    ...
    try:
        ...
        validation_res = f"Evaluation failed: " + str(e)
    else:
