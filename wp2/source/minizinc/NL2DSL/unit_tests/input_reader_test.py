...
[
    ...
    This problem involves a collection of items, where each have a height and a width. We have 6 different items given in the parameters.
...
[
    ...
    def test_fixed_objects_fixed_inoutput_values(self):
        ...
        self.assertEqual(objects, {
            ...
            'X_Y_Position': 'X_Y_Position = DSRecord({"x" : DSInt(lb=0, ub=10), "y" : DSInt(lb=0, ub=5)})\n'})
        self.assertEqual(intput_variable_spec[0], {
            'description': '',
